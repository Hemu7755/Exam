...
<body>
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    <div class="modal-footer justify-content-center">
                        ...
                        <button class="but" style="--clr:black" type="submit" id="back" name="back"><span>Back</span><i></i></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <center>
            ...
            <div class="table-container" id="resultTable">
                <form action="" method="post">
                    <table>
                        ...
                        $query = "SELECT * FROM result WHERE status='1' ORDER BY create_date_time DESC LIMIT $start, $itemsPerPage";
        ...
        <?php
        $totalCountQuery = "SELECT COUNT(*) as total FROM result WHERE status='1'";
